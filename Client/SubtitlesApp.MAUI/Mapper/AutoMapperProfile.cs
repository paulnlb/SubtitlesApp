...
public class AutoMapperProfile : Profile
{
    public AutoMapperProfile()
    {
        ...
        CreateMap<SubtitleDto, Subtitle>()
            .ForMember(dest => dest.TimeInterval, opts => opts.MapFrom(src => new TimeInterval(src.StartTime, src.EndTime)));

        CreateMap<SubtitleDto, VisualSubtitle>().IncludeBase<SubtitleDto, Subtitle>();

        CreateMap<Subtitle, SubtitleDto>()
            .ForMember(dest => dest.StartTime, opts => opts.MapFrom(src => src.TimeInterval.StartTime))
